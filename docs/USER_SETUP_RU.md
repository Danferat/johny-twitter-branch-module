...
Пока вы не нажали кнопку публикации, модуль не отправляет публикационные запросы в Twitter/X API. Генерация черновика, правки текста и выбор модели работают через AI/Telegram-логику host-проекта и не публикуют ничего в X.
...
Если кнопка нажата повторно или Telegram доставил callback повторно, свежая интеграция должна показать предупреждение и не отправлять второй запрос публикации в X.
